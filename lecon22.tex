...
\begin{itemize}
    ...
    \item \ac{اَلْخَطُّ اَلْكُوفِيُّ}{库法体}
    \item \ac{خَطُّ النَّسْخِ}{誊抄体（纳斯赫体）}
    \item \ac{خَطَّ الثُّلُثِ}{三一体（苏鲁斯体）}
    \item \ac{اَلْخَطُّ الْفَارِسِيُّ}{波斯体}
    \item \ac{اَلْخَطُّ الدِّيوَانِي}{公文体（迪瓦尼体）}
    \item \ac{خَطُّ الرُّقْعَةِ}{行书体（卢格阿体）}
    \item \ac{بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيمِ}{伊斯兰教徒表示希望得到神的佑助的宗教短语（直译为：奉至仁至慈的 \arm{ﷲ} 之名），``太斯米''}
    \item \ac{لَا إِلَهَ إِلَّا اللهُ مُحَمَّدٌ رَسُولُ اللهِ}{伊斯兰教徒所信奉的信条（直译为：除 \arm{ﷲ} 外没有别的神灵，\arm{ﷴ} 是 \arm{ﷲ} 的使者），``清真言''} 
    \item \ac{فَكِّرْ كَثِيرًا وَتَكَلَّمْ قَلِيلًا، تَكَلَّمْ قَلِيلًا وَافْعَلْ كَثِيرًا}{多思少言，少言多行}
    \item \ac{اَلْمَغْرِبُ}{马格里布}
    \item \ac{اَلْخَطُّ الْمَغْرِبِيُّ}{马格里布体}
    \item \ac{اَلْأَنْدَلُسُ}{安达卢斯（今西班牙附近）}
    \item \ac{اَلْخَطُّ الصِّينِيُّ}{中国体}
    \item \ac{اَلطُّغْرَاءُ}{花押}
\end{itemize}
